...
//         const blueApple = new Image();
//         const body_topLeft = new Image();
//         const body_topRight = new Image();
//         const body_horizontal = new Image();
//         const body_bottomLeft = new Image();
//         const body_bottomRight = new Image();
...
//         let docRef = db.collection("answers").doc(id);
...
//             gameLoopTimeout = setTimeout(render, 100);
//         }
//         render()
